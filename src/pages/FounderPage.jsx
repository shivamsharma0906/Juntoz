...
export default function FounderPage() {
  const bioParagraphs = [
    ...
    <p key="2">
      ...
      <span className="text-[#111111] font-bold">5 years at Tata Consultancy Services (TCS)</span>{' '}
      and <span className="text-[#111111] font-bold">4 years at Nokia</span>, where he
    ...
    <div className="pt-28 md:pt-36 pb-16 bg-[#F7F6F2] min-h-screen">
      ...
      <TeamMemberProfile
        ...
        vision={{
          label: 'Vision',
          quote:
            'To build Juntoz into a globally recognized agency that empowers businesses worldwide with innovative digital marketing and growth systems.',
