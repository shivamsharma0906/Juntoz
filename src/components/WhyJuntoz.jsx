...
const BULLETS = [
  ...
  { icon: '◎', text: 'Result-Driven Campaigns' },
];
...
export default function WhyJuntoz() {
  ...
  /* ── Scroll parallax on background glows (moved from About.jsx) ── */
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div ref={glow1Ref} style={{ position:'absolute', top:'20%', left:'-5%', width:'400px', height:'400px', background:'radial-gradient(ellipse, rgba(0,245,212,0.07) 0%, transparent 65%)', filter:'blur(60px)', willChange: 'transform' }} />
        <div ref={glow2Ref} style={{ position:'absolute', bottom:'10%', right:'-5%', width:'350px', height:'350px', background:'radial-gradient(ellipse, rgba(123,47,255,0.08) 0%, transparent 65%)', filter:'blur(60px)', willChange: 'transform' }} />
      </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-12 sm:mb-16">
          ...
          <div>
            ...
            {/* Bullet points */}
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 flex-wrap" style={fade(0.32)}>
              {BULLETS.map((b, i) => (
          ...
          <div className="relative" style={fade(0.18)}>
            ...
            <div className="absolute -top-5 right-6 sm:right-10 flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 z-20">
              <svg
