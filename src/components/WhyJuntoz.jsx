  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        ...
        <div ref={glow2Ref} style={{ position:'absolute', bottom:'10%', right:'-5%', width:'350px', height:'350px', background:'radial-gradient(ellipse, rgba(93,46,133,0.08) 0%, transparent 65%)', filter:'blur(60px)', willChange: 'transform' }} />
      </div>
