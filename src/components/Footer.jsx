...
export default function Footer() {
  return (
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10 pt-12 sm:pt-18 pb-4 sm:pb-6 space-y-10 sm:space-y-14">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-8 sm:gap-12 border-b border-white/12 pb-12 sm:pb-16">
          <div className="text-center lg:text-left space-y-4 max-w-xl">
            ...
            <h2 className="font-heading font-black text-3xl sm:text-5xl lg:text-6xl uppercase tracking-tight leading-none text-white">
              Let's Talk About <br />
              <span className="text-[#E84A2A]">Your Growth.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4 w-full lg:max-w-2xl">
            ...
            <a
              ...
              className="group flex flex-row sm:flex-col items-center sm:items-start justify-between p-4 sm:p-6 rounded-2xl sm:rounded-3xl border border-white/12 bg-[#1A1A1A] hover:border-[#E84A2A]/40 transition-all duration-300 relative overflow-hidden"
            >
              <div className="w-10 h-10 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 mb-0 sm:mb-6 transition-colors duration-300 group-hover:bg-[#E84A2A]/15 group-hover:border-[#E84A2A]/30">
                <svg className="w-4 h-4 text-white/80 group-hover:text-[#E84A2A] transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <svg className="w-4 h-4 block sm:hidden shrink-0 ml-2 text-white/30 group-hover:text-[#E84A2A] group-hover:translate-x-1 transition-all duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            >
              <div className="w-10 h-10 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center shrink-0 mb-0 sm:mb-6 transition-colors duration-300 group-hover:bg-[#E84A2A]/15 group-hover:border-[#E84A2A]/30">
                <svg className="w-4 h-4 text-white/80 group-hover:text-[#E84A2A] transition-colors fill-current" viewBox="0 0 24 24">
            ...
            <div className="flex gap-2.5 pt-1">
              {socials.map((s) => (
                <a
                  ...
                  rel="noopener noreferrer"
                  aria-label={s.label}
                  className="w-9 h-9 rounded-full flex items-center justify-center border border-white/12 text-white/70 bg-[#1A1A1A] hover:text-[#E84A2A] hover:border-[#E84A2A]/40 transition-all duration-200"
                >
          ...
          <div className="md:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 md:gap-8">
            ...
            <div className="space-y-8 md:space-y-0">
                  ...
                  {footerServices.map((link) => (
                    <li key={link.label}>
                      <Link
                        ...
                        className="font-body text-xs sm:text-sm text-white/70 hover:text-[#E84A2A] transition-colors duration-200 block"
                      >
                        {link.label}
                      </Link>
                    </li>
              ...
              <div className="md:hidden space-y-3 pt-2">
                <span className="block font-sans font-bold text-xs uppercase tracking-wider text-[#E84A2A]">Specialties</span>
      ...
      <div
        className="relative w-full overflow-hidden pointer-events-none select-none -mt-3 sm:-mt-2"
        style={{ height: 'clamp(75px, 13vw, 175px)' }}
      >
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 whitespace-nowrap font-heading font-black uppercase text-center"
          style={{
