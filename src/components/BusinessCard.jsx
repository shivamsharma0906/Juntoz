      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-4xl relative z-10">
        ...
        <ScrollReveal data-reveal="up" delay={150}>
          <div className="relative rounded-3xl bg-white border border-[#DEDED7] shadow-card overflow-hidden transition-all duration-300 hover:shadow-hover">
            ...
            <div className="h-1 w-full bg-[#5D2E85]" />
              ...
              <div className="flex-1 text-left space-y-4">
                ...
                <div className="pt-3">
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 px-6 py-3 rounded-full bg-[#111111] text-white font-heading font-bold text-xs uppercase tracking-wider transition-all duration-300 hover:bg-[#5D2E85] shadow-sm active:scale-[0.98]"
                  >
